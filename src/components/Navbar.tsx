    ...
    <nav>
                ...
                <DropdownMenuContent className="w-56" align="end" forceMount>
                  <DropdownMenuLabel className="font-normal">
                    <div className="flex flex-col space-y-1">
                      <p
                        className="text-sm font-medium leading-none bg-gradient-to-r from-purple-600
                ...
                <div>
                  <Link href="/auth?type=login">
                    <Button
                     ...
                     bg-clip-text text-transparent border-2 border-gray-300 cursor-pointer"
                    >
                      登入
                    </Button>
                  </Link>
      ...
      {isMobileMenuOpen && (
        <div ref={mobileMenuRef} className="md:hidden bg-gray-100">
          <div className="px-2 pt-2 pb-3 space-1 sm:px-3">
            ...
            text-gray-500 hover:text-white hover:bg-purple-500"
            ...
            {user ? (
              <div className="mt-3 px-2 space-y-1">
                ...
                <button
                  onClick={handleLogout}
                  className="block px-3 py-2 rounded-md text-base font-medium
                 text-gary-500 hover:text-white hover:bg-purple-500 w-full text-left cursor-pointer"
                >
                  登出
                </button>
              </div>
