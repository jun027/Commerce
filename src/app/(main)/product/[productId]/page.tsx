      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="relative overflow-hidden rounded-lg">
            <Image
              ...
              width={800}
              height={800}
              className="object-contain w-full max-h-[400px] transition-transform 
            ...
            <div className="flex space-x-4">
              <Button
                className="flex-1 bg-gradient-to-r from-purple-500 via-pink-500 to-red-500
                 hover:from-purple-600 hover:via-pink-600 hover:to-red-600 text-white font-semibold cursor-pointer"
        ...
        {relatedProducts.length > 0 && (
          <section className="mt-16">
            <ProductCatalog title="相似產品" products={relatedProducts} />
          </section>
        )}
      </main>
    </div>
